CREATE TABLE [metadata].[Orchestrators]
	(
    ...
    CONSTRAINT [FK_Orchestrators_Subscriptions] FOREIGN KEY([SubscriptionId]) REFERENCES [metadata].[Subscriptions] ([SubscriptionId]),
